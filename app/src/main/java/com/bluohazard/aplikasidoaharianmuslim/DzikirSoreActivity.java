...
public class DzikirSoreActivity extends AppCompatActivity implements DaftarDzikirPagiAdapter.OnDaftarClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftarDzikirPagiAdapter.setListener(this);
